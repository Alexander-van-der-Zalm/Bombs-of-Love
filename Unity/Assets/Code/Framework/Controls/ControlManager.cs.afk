...
public class ControlManager : Singleton<ControlManager> 
{
    ...
    void FixedUpdate()
    {
        ...
        {
            if (cs != null && cs.UpdateType == ControlScheme.UpdateTypeE.FixedUpdate)
                cs.Update();
        }
    }
    ...
    void Update()
    {
        foreach (ControlScheme cs in ControlSchemes)
        {
            if (cs != null && cs.UpdateType == ControlScheme.UpdateTypeE.Update)
                cs.Update();
        }
    }
    ...
    void LateUpdate()
    {
        foreach (ControlScheme cs in ControlSchemes)
        {
            if (cs != null && cs.UpdateType == ControlScheme.UpdateTypeE.LateUpdate)
                cs.Update();
        }
    }
